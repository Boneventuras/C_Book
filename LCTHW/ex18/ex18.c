...
typedef int *(*test_func)(int *, int, compare_cb);
...
int *selection_sort(int *num, int len, compare_cb cmp){
...
*/
void test_sorting(int *numbers, int count, compare_cb cmp, test_func test){
	int i = 0;
	int *sorted = test(numbers, count, cmp);
